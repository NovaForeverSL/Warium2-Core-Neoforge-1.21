...
public final class ModFluids {
    public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.FLUID_TYPES, Warium.MODID);
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(Registries.FLUID, Warium.MODID);
    ...
    private static DeferredHolder<FluidType, FluidType> registerFluidType(final String name) {
        return FLUID_TYPES.register(name, () -> new FluidType(FluidType.Properties.create()
                .descriptionId("fluid_type." + Warium.MODID + "." + name)
    ...
    public static final class ClientExtensions {
        ...
        private static void registerFluid(final RegisterClientExtensionsEvent event, final FluidType type, final String textureStem) {
            event.registerFluidType(new IClientFluidTypeExtensions() {
                private final ResourceLocation still = ResourceLocation.fromNamespaceAndPath(Warium.MODID, "block/fluid_" + textureStem + "_still");
                private final ResourceLocation flowing = ResourceLocation.fromNamespaceAndPath(Warium.MODID, "block/fluid_" + textureStem + "_flow");
