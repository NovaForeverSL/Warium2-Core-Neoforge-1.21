package net.warium2_core.explosions;
...
@EventBusSubscriber(modid = "warium2_core", value = Dist.CLIENT)
public class ScaledExplosion extends BaseExplosion {
    ...
    private enum SoundTier {
        SMALL   ( 3.0,          1.15f, 1.2f, "warium2_core:explosionsmallfar",     30F,  1f,    1.05f, "warium2_core:explosionsmall",     3F,  1f,    1.05f),
        MEDIUM  (10.0,          1.15f, 1.2f, "warium2_core:explosionlargefar",     30F,  1.15f, 1.2f,  "warium2_core:explosionlarge",     4F,  1.15f, 1.2f ),
        LARGE   (20.0,          1.15f, 1.2f, "warium2_core:explosionlargefar",     64F,  1.15f, 1.2f,  "warium2_core:explosionlarge",     6F,  1.15f, 1.2f ),
        MEGA    (30.0,          1.15f, 1.2f, "warium2_core:explosionlargefar",     64F,  1.15f, 1.2f,  "warium2_core:explosionlarge",     8F,  1.15f, 1.2f ),
        COLOSSAL(Double.MAX_VALUE, 0.95f, 1.0f, "warium2_core:explosioncolossalfar", 400F, 1.15f, 1.2f, "warium2_core:explosioncolossal", 32F,  1.15f, 1.2f );
    ...
    public void playSound(boolean playSound) {
        ...
        queueSound(tickDelay, x, y, z, "warium2_core:explosionrumble", rumbleVol, rumblePitch);
